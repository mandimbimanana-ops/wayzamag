...
const CATEGORIES = [
  { id: 1,  name: "Fast, Grill & Resto",    icon: "🔥",  glow: "#C8920A", sub: "Tables d'exception",    img: "data:image/webp;base64," },
        ...
        {spot.gps && (
          <button
            onClick={() => {
              ...
              // Détection mobile pour lien natif (intent Android / universal link iOS)
              const isMobile = /Android|iPhone|iPad/i.test(navigator.userAgent);
              const isAndroid = /Android/i.test(navigator.userAgent);
              const isIOS = /iPhone|iPad/i.test(navigator.userAgent);
              const dest = `${lat},${lng}`;
              if (isAndroid) {
                // Intent Android — ouvre Google Maps ou demande l'app
                window.location.href = `geo:${dest}?q=${dest}(${label})`;
                setTimeout(() => {
...
const BanniereHautCarousel = ({ ads }) => {
  ...
  const PLACEHOLDER_BH = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=900&q=70";
  if (!filtered.length) return (
    <div style={{ margin: "0 0 20px", borderRadius: 16, overflow: "hidden", border: "0.5px solid rgba(200,146,10,0.35)", position: "relative", height: 90, cursor: "pointer" }}
      onClick={() => {}}>
      <img src={PLACEHOLDER_BH} alt="pub" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.45 }} />
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(13,43,48,0.96) 0%, rgba(13,43,48,0.5) 60%, transparent 100%)", display: "flex", alignItems: "center", padding: "0 16px", gap: 10 }}>
        <span style={{ fontSize: 18, flexShrink: 0 }}>📢</span>
        <div>
          <p style={{ fontSize: 12, fontWeight: 700, color: "#C8920A" }}>Votre pub ici !</p>
          <p style={{ fontSize: 9, color: "rgba(244,247,247,0.45)", letterSpacing: "0.1em" }}>Bannière Haut · Contactez <span style={{ color: "#C8920A", fontWeight: 700 }}>#wayza</span></p>
        </div>
      </div>
    </div>
  );
...
const BanniereBasCarousel = ({ ads }) => {
  ...
  const PLACEHOLDER_BB = "https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=900&q=70";
  if (!filtered.length) return (
    <div style={{ margin: "16px 0 0", borderRadius: 12, overflow: "hidden", border: "0.5px solid rgba(200,146,10,0.2)", position: "relative", height: 54, cursor: "pointer" }}>
      <img src={PLACEHOLDER_BB} alt="pub" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.3 }} />
      <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", padding: "0 14px", gap: 8, background: "rgba(13,43,48,0.65)" }}>
        <span style={{ fontSize: 12, flexShrink: 0 }}>📢</span>
        <div style={{ width: 1, height: 16, background: "rgba(200,146,10,0.3)", flexShrink: 0 }} />
        <p style={{ fontSize: 11, fontWeight: 700, color: "rgba(200,146,10,0.8)" }}>Votre pub ici ! <span style={{ color: "#C8920A", fontWeight: 800 }}>#wayza</span></p>
        <span style={{ marginLeft: "auto", fontSize: 9, color: "rgba(200,146,10,0.5)", fontWeight: 600 }}>BANNIÈRE BAS</span>
      </div>
    </div>
  );
  const ad = filtered[idx];
...
// ─── HERO + AGENDA CAROUSEL ──────────────────────────────────
const AGENDA_IMGS = [
  "https://images.unsplash.com/photo-1568430462989-44163eb1752f?w=700&q=75",
  "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=700&q=75",
  "https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=700&q=75",
  "https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?w=700&q=75",
];

const HeroWithAgenda = ({ onMag, ads }) => {
  const [agendaIdx, setAgendaIdx] = useState(0);
  const tickerAds = (ads || []).filter(a => a.type === "banniere_haut" && a.actif);
  const agendaItems = tickerAds.length > 0
    ? tickerAds.map((a, i) => ({ titre: a.titre, texte: a.texte, img: a.image_url || AGENDA_IMGS[i % AGENDA_IMGS.length], wa: a.lien_wa }))
    : MAG.map((m, i) => ({ titre: m.titre, texte: m.soustitre, img: m.img || AGENDA_IMGS[i % AGENDA_IMGS.length], article: m }));

  useEffect(() => {
    if (agendaItems.length <= 1) return;
    const t = setInterval(() => setAgendaIdx(i => (i + 1) % agendaItems.length), 4000);
    return () => clearInterval(t);
  }, [agendaItems.length]);

  const current = agendaItems[agendaIdx];

  return (
    <div style={{ margin: "0 16px 24px", display: "flex", gap: 10, height: 220, borderRadius: 20, overflow: "hidden" }}>
      {/* Gauche — image article hero, cliquable */}
      <div
        style={{ flex: "0 0 58%", position: "relative", cursor: "pointer", borderRadius: 16, overflow: "hidden" }}
        onClick={() => onMag(MAG[0])}
      >
        <img
          src={MAG[0]?.img || AGENDA_IMGS[0]}
          alt="hero"
          style={{ width: "100%", height: "100%", objectFit: "cover" }}
          onError={e => { e.target.src = AGENDA_IMGS[0]; }}
        />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, #0D2B30 0%, rgba(13,43,48,0.2) 55%, transparent 100%)" }} />
        <div style={{ position: "absolute", inset: 0, padding: "14px 14px", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          <span style={{ fontSize: 7, fontWeight: 800, letterSpacing: "0.35em", color: "#C8920A", marginBottom: 5 }}>À LA UNE</span>
          <h2 style={{ fontSize: 13, fontWeight: 800, color: "#F4F7F7", lineHeight: 1.3, marginBottom: 6, fontStyle: "italic" }}>{MAG[0].titre}</h2>
          <span style={{ fontSize: 9, color: "rgba(244,247,247,0.6)", letterSpacing: "0.15em", display: "flex", alignItems: "center", gap: 4 }}>
            LIRE <Icon name="chevron" size={10} color="rgba(244,247,247,0.6)" />
          </span>
        </div>
      </div>

      {/* Droite — agenda carousel */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", borderRadius: 16, overflow: "hidden", border: "0.5px solid rgba(200,146,10,0.25)", background: "rgba(13,43,48,0.8)", position: "relative" }}>
        {/* Image de fond qui change */}
        <img
          key={agendaIdx}
          src={current.img || AGENDA_IMGS[agendaIdx % AGENDA_IMGS.length]}
          alt={current.titre}
          style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", opacity: 0.35, transition: "opacity 0.4s" }}
          onError={e => { e.target.src = AGENDA_IMGS[agendaIdx % AGENDA_IMGS.length]; }}
        />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(13,43,48,0.98) 0%, rgba(13,43,48,0.6) 100%)" }} />

        {/* Header */}
        <div style={{ position: "relative", padding: "10px 10px 0", flexShrink: 0 }}>
          <p style={{ fontSize: 7, fontWeight: 800, letterSpacing: "0.3em", color: "#C8920A" }}>✦ AGENDA</p>
        </div>

        {/* Contenu carousel */}
        <div
          style={{ flex: 1, position: "relative", padding: "6px 10px 10px", display: "flex", flexDirection: "column", justifyContent: "flex-end", cursor: "pointer" }}
          onClick={() => {
            if (current.article) onMag(current.article);
            else if (current.wa) window.open(`https://wa.me/${current.wa.replace(/[^0-9]/g,"")}`, "_blank");
          }}
        >
          <p style={{ fontSize: 11, fontWeight: 700, color: "#F4F7F7", lineHeight: 1.3, marginBottom: 3 }}>{current.titre}</p>
          {current.texte && <p style={{ fontSize: 9, color: "rgba(244,247,247,0.5)", lineHeight: 1.4, marginBottom: 8 }}>{current.texte}</p>}
          {/* Dots */}
          <div style={{ display: "flex", gap: 4 }}>
            {agendaItems.map((_, i) => (
              <div key={i} onClick={e => { e.stopPropagation(); setAgendaIdx(i); }} style={{
                width: i === agendaIdx ? 12 : 4, height: 4, borderRadius: 2,
                background: i === agendaIdx ? "#C8920A" : "rgba(200,146,10,0.3)",
                cursor: "pointer", transition: "all 0.3s",
              }} />
            ))}
          </div>
...
const HomeScreen = ({ city, setCity, geoCity, geoQuartier, onSpot, onMag, onTab, ads, spots = SPOTS_FALLBACK, onInscription }) => {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0 }}>
      ...
      {/* Contenu scrollable */}
      <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", paddingBottom: 20, minHeight: 0 }}>
      {/* Hero — image à gauche + agenda carousel à droite */}
      <HeroWithAgenda onMag={onMag} ads={ads} />
      ...
      {/* Catégories — pills texte seul */}
      <div style={{ padding: "0 16px 8px" }}>
        <p style={{ fontSize: 9, color: "#C8920A", letterSpacing: "0.3em", fontWeight: 700, marginBottom: 10 }}>CATÉGORIES</p>
        <div style={{ display: "flex", gap: 6, overflowX: "auto", scrollbarWidth: "none", WebkitOverflowScrolling: "touch", paddingBottom: 4, marginBottom: 14, marginLeft: -16, paddingLeft: 16, marginRight: -16, paddingRight: 16 }}>
          {CATEGORIES.map(cat => {
            const active = selectedCat === cat.name;
            const spotCount = byCity.filter(s => s.cat === cat.name).length;
            const isEmpty = spotCount === 0;
            const handleCatClick = () => { if (!isEmpty) setSelectedCat(active ? null : cat.name); };
            return (
              <button key={cat.id} onClick={handleCatClick} style={{
                flexShrink: 0,
                padding: "7px 14px",
                borderRadius: 20,
                border: active ? `1.5px solid ${cat.glow}` : `0.5px solid ${isEmpty ? "rgba(255,255,255,0.08)" : cat.glow + "60"}`,
                background: active ? `${cat.glow}22` : isEmpty ? "rgba(255,255,255,0.02)" : "rgba(255,255,255,0.04)",
                color: active ? cat.glow : isEmpty ? "rgba(244,247,247,0.3)" : "rgba(244,247,247,0.75)",
                fontSize: 11, fontWeight: active ? 700 : 500,
                letterSpacing: "0.02em",
                cursor: isEmpty ? "default" : "pointer",
                fontFamily: "inherit",
                transition: "all 0.15s",
                boxShadow: active ? `0 0 10px ${cat.glow}30` : "none",
                whiteSpace: "nowrap",
              }}>
                {cat.name}
              </button>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ height: 440, position: "relative", overflow: "hidden" }}>
          <img src="https://images.unsplash.com/photo-1559339352-11d035aa65de?w=700&q=75" alt="pub" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          ...
          <div style={{ position: "absolute", inset: 0, padding: "0 28px 32px", display: "flex", flexDirection: "column", justifyContent: "flex-end", textAlign: "center", alignItems: "center" }}>
            <p style={{ fontSize: 9, color: "#C8920A", letterSpacing: "0.4em", fontWeight: 700, marginBottom: 10 }}>✦ POP UP EXCLUSIF</p>
            <h3 style={{ fontSize: 26, fontWeight: 800, color: "#F4F7F7", fontStyle: "italic", lineHeight: 1.25, marginBottom: 10 }}>Votre pub ici !</h3>
            <p style={{ fontSize: 13, color: "rgba(244,247,247,0.6)", lineHeight: 1.7, marginBottom: 22 }}>
              Visibilité maximale dès l'ouverture de l'app.
            </p>
            <div style={{ background: "rgba(200,146,10,0.15)", border: "0.5px solid rgba(200,146,10,0.5)", borderRadius: 14, padding: "12px 18px", marginBottom: 20, width: "100%" }}>
              <p style={{ fontSize: 10, color: "#C8920A", fontWeight: 700, letterSpacing: "0.12em" }}>200 000 Ar/jour · Boost vendredi +30%</p>
            </div>
            <div style={{ fontSize: 13, color: "rgba(244,247,247,0.6)" }}>
              Contactez <span style={{ color: "#C8920A", fontWeight: 800 }}>#wayza</span>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="wayza-app-root" style={{
      ...
      <style>{`
        ...
        @keyframes tickerFixed { 0%{transform:translateX(0)} 100%{transform:translateX(-50%)} }
      ...
      {/* Bottom nav */}
      <div className="wayza-bottom-nav" style={{ position: "relative", bottom: 0, left: 0, right: 0, padding: isMobileLandscape ? "6px 20px 4px" : "10px 20px 8px", paddingTop: isMobileLandscape ? "6px" : "8px", paddingBottom: 26, background: "linear-gradient(to top, #0D2B30 70%, transparent)", flexShrink: 0, display: isDesktop ? "none" : "block", overflow: "visible" }}>
      ...
      {/* ─── TICKER FIXED — toujours visible, pleine largeur, tout en bas ─── */}
      <div style={{
        position: "fixed",
        bottom: 0,
        left: 0,
        ...
        height: 22,
        background: "#000",
        borderTop: "1px solid rgba(200,146,10,0.4)",
        overflow: "hidden",
        zIndex: 9980,
        display: "flex",
        alignItems: "center",
        ...
        <div style={{
          ...
          whiteSpace: "nowrap",
          animation: "tickerFixed 40s linear infinite",
        }}>
