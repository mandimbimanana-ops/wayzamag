...
export default function WayzaPrestigeApp() {
  ...
  return (
    <div className="wayza-app-root" style={{
      width: "100%", maxWidth: "var(--app-max)", margin: "0 auto",
      height: "100dvh",
      ...
      <style>{`
        :root { --app-max: 100vw; }
        @media (orientation: landscape) and (max-width: 767px) { :root { --app-max: 100vw; } }
        ...
        * { scrollbar-width: none; box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { background: #0D2B30; }
        @media (min-width: 768px) {
          .wayza-app-root { max-width: 100vw !important; width: 100vw !important; height: 100vh !important; }
          .wayza-main-layout { display: flex !important; flex-direction: row !important; flex: 1 !important; overflow: hidden !important; }
          .wayza-sidebar { display: flex !important; flex-direction: column !important; width: 220px !important; min-width: 220px !important; background: rgba(0,0,0,0.3) !important; border-right: 0.5px solid rgba(200,146,10,0.15) !important; padding: 24px 16px !important; gap: 8px !important; overflow-y: auto !important; }
          .wayza-bottom-nav { display: none !important; }
          .wayza-top-header { display: none !important; }
          .wayza-main-content { flex: 1 !important; overflow-y: auto !important; height: 100% !important; }
          .wayza-spots-grid { display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 16px !important; }
          .wayza-cats-grid { grid-template-columns: repeat(4, 1fr) !important; }
        }
        @media (min-width: 1200px) {
          .wayza-sidebar { width: 260px !important; min-width: 260px !important; }
      ...
      {/* Header */}
      {!selectedSpot && (
        <div className="wayza-top-header" style={{ padding: "16px 20px 10px", flexShrink: 0, display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
      ...
      <div className="wayza-main-layout" style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: "column" }}>
        {/* Sidebar desktop */}
        <div className="wayza-sidebar" style={{ display: "none" }}>
        ...
        {/* Contenu principal */}
        <div className="wayza-main-content" style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: "column" }}>
          {renderMain()}
        </div>
      </div>

      {/* Bottom nav */}
      <div className="wayza-bottom-nav" style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "12px 20px 20px", background: "linear-gradient(to top, #0D2B30 60%, transparent)", flexShrink: 0 }}>
