...
export default function WayzaPrestigeApp() {
      ...
      try {
        ...
        if (!error && data?.length) {
          ...
          const normalized = data.map(s => ({
            ...
            img: s.img || s.photo_principale || s.image_url || s.photo || "",
  ...
  return (
    <div className="wayza-app-root" style={{
      ...
      {/* Ticker dynamique — bas de page */}
      {!isDesktop && (
        <div style={{ background: "#000", padding: "4px 0", borderTop: "0.5px solid rgba(200,146,10,0.2)", overflow: "hidden", flexShrink: 0, zIndex: 50 }}>
          ...
          {navItems.map(item => {
            ...
            return (
              <button key={item.id} onClick={() => { setTab(item.id); setSelectedSpot(null); setSelectedArticle(null); }} style={{
                ...
                {item.id === "mag" ? (
                  <div style={{
                    width: 44, height: 44, marginTop: -10,
