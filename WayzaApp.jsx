...
const CATEGORIES = [
  { id: 1,  name: "Fast, Grill & Resto",    icon: "🍽",  glow: "#C8920A", sub: "Tables d'exception",    img: null },
...
const PassBadge = ({ type }) => {
  ...
  return (
    <span style={{
      ...
      color: "#0D2B30",
      border: "none",
      fontSize: 8, fontWeight: 600, letterSpacing: "0.14em", fontFamily: "'DM Sans', sans-serif",
...
const PassGlowClient = ({ spotId }) => {
  ...
  if (loading) return (
    <div style={{ marginBottom: 24 }}>
      <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.22em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 10 }}>✦ ÉQUIPE & PRESTATIONS</p>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          {[{ id: "equipe", l: "✦ Équipe" }, { id: "prestations", l: "◈ Soins & Services" }].map(o => (
            <button key={o.id} onClick={() => setOnglet(o.id)} style={{
              flex: 1, padding: "9px 0", borderRadius: 10, cursor: "pointer", fontWeight: 700, fontSize: 11, fontFamily: "'DM Sans', sans-serif",
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 4 }}>
                      <p style={{ fontSize: 14, fontWeight: 700, color: "#F4F7F7", fontFamily: "'Playfair Display', Georgia, serif" }}>{s.nom}</p>
                      {s.snacking && (
                ...
                {!complet && (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 800, fontSize: 12, letterSpacing: "0.1em", fontFamily: "'DM Sans', sans-serif",
    ...
    <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", paddingBottom: 20, minHeight: 0 }}>
      ...
      <div style={{ position: "relative", height: 260 }}>
        ...
        <button onClick={onBack} style={{
          ...
          display: "flex", alignItems: "center", gap: 6, color: "#F4F7F7", fontSize: 12, fontFamily: "'DM Sans', sans-serif",
        }}>
      ...
      <div style={{ padding: "0 20px", marginTop: -30, position: "relative" }}>
        ...
        <h1 style={{ fontSize: 26, fontWeight: 900, color: "#F4F7F7", lineHeight: 1.2, marginBottom: 4, fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif" }}>{spot.nom}</h1>
        ...
        {spot.horaires && Object.keys(spot.horaires).length > 0 && (
          <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: 14, padding: "14px 16px", marginBottom: 20, border: "0.5px solid rgba(200,146,10,0.15)" }}>
            <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.22em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 10 }}>HORAIRES</p>
        ...
        {(spot.tarif_entree || spot.tarif_fourchette || spot.happy_hour || spot.menu_jour || spot.tarif_vip) && (
          <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: 14, padding: "14px 16px", marginBottom: 20, border: "0.5px solid rgba(200,146,10,0.15)" }}>
            <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.22em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 10 }}>TARIFS</p>
        ...
        {spot.gps && (
          <button
            onClick={() => {
              const parts = spot.gps.replace(/\s/g, "").split(",");
              const lat = parseFloat(parts[0]);
              const lng = parseFloat(parts[1]);
              if (isNaN(lat) || isNaN(lng)) return;
              const label = encodeURIComponent(spot.nom || "destination");
            ...
            style={{
              ...
              width: "100%", marginBottom: 20, fontFamily: "'DM Sans', sans-serif",
              color: "#C8920A",
            }}
          >
        ...
        {spot.parking && (spot.parking.moto || spot.parking.auto || spot.parking.gardienne || spot.parking.note) && (
          <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: 14, padding: "14px 16px", marginBottom: 20, border: "0.5px solid rgba(255,255,255,0.08)" }}>
            <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.22em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 10 }}>PARKING</p>
        ...
        {(spot.age_minimum || spot.dress_code || spot.style || spot.enfants === false) && (
          <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: 14, padding: "14px 16px", marginBottom: 20, border: "0.5px solid rgba(255,255,255,0.08)" }}>
            <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.22em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 10 }}>AMBIANCE</p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "12px 14px 14px" }}>
        <p style={{ fontSize: 9, color: "#C8920A", letterSpacing: "0.18em", marginBottom: 4, fontWeight: 600, fontFamily: "'DM Sans', sans-serif" }}>{spot.ville.toUpperCase()}</p>
        <h3 style={{ fontSize: 15, fontWeight: 700, color: "#F4F7F7", marginBottom: 4, lineHeight: 1.3, fontFamily: "'Playfair Display', Georgia, serif" }}>{spot.nom}</h3>
    ...
    <div style={{ margin: "0 0 20px", borderRadius: 16, overflow: "hidden", border: "0.5px solid rgba(200,146,10,0.3)", position: "relative", height: 90, background: "rgba(200,146,10,0.05)", cursor: "pointer" }}
      ...
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(13,43,48,0.92) 0%, transparent 65%)", display: "flex", alignItems: "center", padding: "0 16px" }}>
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 14, fontWeight: 700, color: "#F4F7F7", fontFamily: "'Playfair Display', Georgia, serif" }}>{ad.titre}</p>
...
const HomeScreen = ({ city, setCity, geoCity, geoQuartier, onSpot, onMag, onTab, ads, spots = SPOTS_FALLBACK, onInscription }) => {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0 }}>
      ...
      {/* Contenu scrollable */}
      <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", paddingBottom: 20, minHeight: 0 }}>
      {/* Hero mag + Agenda côte à côte */}
      <div style={{ margin: "0 16px 24px", display: "flex", gap: 10, height: 260 }}>
        {/* Image article à la une — gauche */}
        <div style={{ flex: "0 0 55%", position: "relative", borderRadius: 20, overflow: "hidden", cursor: "pointer" }} onClick={() => onMag(MAG[0])}>
          <img src={MAG[0].img} alt="hero" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, #0D2B30 0%, rgba(13,43,48,0.2) 60%, transparent 100%)" }} />
          <div style={{ position: "absolute", inset: 0, padding: "14px 14px", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
            <span style={{ fontSize: 8, fontWeight: 800, letterSpacing: "0.3em", color: "#C8920A", marginBottom: 4 }}>À LA UNE</span>
            <h2 style={{ fontSize: 13, fontWeight: 800, color: "#F4F7F7", lineHeight: 1.3, marginBottom: 6, fontStyle: "italic" }}>{MAG[0].titre}</h2>
            <span style={{ fontSize: 9, color: "rgba(244,247,247,0.6)", display: "flex", alignItems: "center", gap: 4 }}>
              LIRE <Icon name="chevron" size={10} color="rgba(244,247,247,0.6)" />
            </span>
          </div>
        </div>
        {/* Agenda carousel — droite */}
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 0, overflow: "hidden", borderRadius: 20, border: "0.5px solid rgba(200,146,10,0.2)", background: "rgba(0,0,0,0.3)" }}>
          <div style={{ padding: "10px 12px 6px", borderBottom: "0.5px solid rgba(200,146,10,0.15)" }}>
            <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.3em", fontWeight: 700 }}>AGENDA</p>
          </div>
          <div style={{ flex: 1, overflowY: "auto", scrollbarWidth: "none" }}>
            {MAG.map((art, i) => (
              <div key={art.id} onClick={() => onMag(art)} style={{
                display: "flex", gap: 8, padding: "8px 10px", cursor: "pointer",
                borderBottom: i < MAG.length - 1 ? "0.5px solid rgba(255,255,255,0.05)" : "none",
                background: i === 0 ? "rgba(200,146,10,0.06)" : "transparent",
              }}>
                <div style={{ width: 38, height: 38, borderRadius: 8, overflow: "hidden", flexShrink: 0 }}>
                  {art.img
                    ? <img src={art.img} alt={art.titre} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    : <div style={{ width: "100%", height: "100%", background: "#1A4A6B" }} />
                  }
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontSize: 7, color: "#C8920A", letterSpacing: "0.15em", fontWeight: 700, marginBottom: 2 }}>{art.date}</p>
                  <p style={{ fontSize: 10, fontWeight: 700, color: "#F4F7F7", lineHeight: 1.25, fontStyle: "italic", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{art.titre}</p>
                  <p style={{ fontSize: 8, color: "rgba(244,247,247,0.4)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{art.soustitre}</p>
                </div>
              </div>
            ))}
          </div>
              ...
              <div key={cat.id} onClick={handleCatClick} style={{
                ...
                <div style={{ position: "absolute", inset: 0, padding: "8px 8px 9px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "flex-start" }}>
                    ...
                    {!active && !isEmpty && !isNavTab && spotCount > 0 && (
                  ...
                  <div>
                    <p style={{ fontSize: 10, fontWeight: 700, color: "#F4F7F7", lineHeight: 1.25 }}>{cat.name}</p>
                  </div>
                </div>
              </div>
            );
...
const MagScreen = ({ onArticle, ads, onInscription }) => {
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", padding: "0 16px 120px", minHeight: 0 }}>
      <div style={{ marginBottom: 20 }}>
        <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.25em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 4 }}>ÉDITION PRESTIGE</p>
        <h2 style={{ fontSize: 22, fontWeight: 900, color: "#F4F7F7", fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif" }}>Wayz'Mag</h2>
      </div>

      {/* Articles sponsorisés Wayz'Mag */}
      {magAds.length > 0 ? (
        <div style={{ marginBottom: 20 }}>
          <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.22em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 10 }}>✦ PARTENAIRES</p>
          {magAds.map(ad => (
            <div key={ad.id} onClick={() => ad.lien_wa && window.open(`https://wa.me/${ad.lien_wa.replace(/[^0-9]/g,"")}`, "_blank")}
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: 14, fontWeight: 700, color: "#F4F7F7", fontFamily: "'Playfair Display', Georgia, serif", marginBottom: 2 }}>{ad.titre}</p>
        ...
        <div style={{ marginBottom: 20, borderRadius: 14, overflow: "hidden", position: "relative", height: 80, cursor: "pointer" }}>
          <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&q=80" alt="pub" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(90deg, rgba(13,43,48,0.85) 0%, rgba(13,43,48,0.4) 100%)" }} />
          <div style={{ position: "relative", padding: "12px 16px", display: "flex", alignItems: "center", gap: 12, height: "100%" }}>
            <span style={{ fontSize: 22 }}>📢</span>
            <div>
              <p style={{ fontSize: 12, fontWeight: 700, color: "#C8920A" }}>Votre pub ici !</p>
              <p style={{ fontSize: 9, color: "rgba(244,247,247,0.6)", lineHeight: 1.5 }}>Article partenaire Wayz'Mag · Contactez <span style={{ color: "#C8920A" }}>#wayza</span></p>
            </div>
          </div>
        </div>
      )}
      ...
      {hero && (
        <div onClick={() => onArticle(hero)} style={{
          ...
          <div style={{ position: "absolute", inset: 0, padding: 22, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
            <span style={{ fontSize: 8, letterSpacing: "0.2em", color: "#C8920A", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 6 }}>{hero.tag}</span>
            <h3 style={{ fontSize: 20, fontWeight: 900, color: "#F4F7F7", lineHeight: 1.25, fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif", marginBottom: 10 }}>
          ...
          {rest.map(a => (
            <div key={a.id} onClick={() => onArticle(a)} style={{
              ...
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "12px 12px" }}>
                ...
                <p style={{ fontSize: 12, fontWeight: 700, color: "#F4F7F7", lineHeight: 1.25, fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif" }}>{a.titre}</p>
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", paddingBottom: 20, minHeight: 0 }}>
      ...
      <div style={{ padding: "20px 20px 0" }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 900, color: "#F4F7F7", fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif", lineHeight: 1.2, margin: "8px 0 4px" }}>{article.titre}</h1>
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0 }}>
      ...
      <div style={{ padding: "16px 16px 0", flexShrink: 0 }}>
        <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.25em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 4 }}>CONTACTS ESSENTIELS</p>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ height: 440, position: "relative" }}>
          <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80" alt="pub" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.97) 0%, rgba(0,0,0,0.5) 50%, rgba(0,0,0,0.2) 100%)" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-end", padding: "0 32px 40px", textAlign: "center" }}>
            ...
            <p style={{ fontSize: 13, color: "rgba(244,247,247,0.6)", lineHeight: 1.7, marginBottom: 28 }}>
              Offrez à votre établissement une visibilité maximale dès l'ouverture de l'app.
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "rgba(244,247,247,0.5)", fontSize: 10 }}>
              <span>Contactez</span>
      ...
      <div style={{
        ...
        <div style={{ height: 440, position: "relative" }}>
          ...
          <div style={{ position: "absolute", inset: 0, padding: "0 28px 32px", display: "flex", flexDirection: "column", justifyContent: "flex-end", textAlign: "center", alignItems: "center" }}>
            ...
            <h3 style={{ fontSize: 24, fontWeight: 900, color: "#F4F7F7", fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif", lineHeight: 1.25, marginBottom: 12 }}>{ad.titre}</h3>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", padding: "0 16px 120px", minHeight: 0 }}>
      <div style={{ marginBottom: 24, paddingTop: 4 }}>
        <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.25em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 4 }}>NOUS REJOINDRE</p>
        <h2 style={{ fontSize: 22, fontWeight: 900, color: "#F4F7F7", fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif" }}>Contacts WAYZA</h2>
      </div>
...
const OffresScreen = ({ onInscription, onContact }) => {
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", padding: "0 16px 120px", minHeight: 0 }}>
      <div style={{ marginBottom: 24, paddingTop: 4 }}>
        <p style={{ fontSize: 8, color: "#C8920A", letterSpacing: "0.25em", fontWeight: 600, fontFamily: "'DM Sans', sans-serif", marginBottom: 4 }}>RÉGIE PUBLICITAIRE</p>
        <h2 style={{ fontSize: 22, fontWeight: 900, color: "#F4F7F7", fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif" }}>Offres à la carte</h2>
      ...
      <div style={{
        ...
        <button onClick={onContact} style={{
          ...
          letterSpacing: "0.12em", fontFamily: "'DM Sans', sans-serif", display: "inline-flex", alignItems: "center", gap: 8,
        }}>
          💬 CONTACTER #WAYZA
        </button>
      </div>
            ...
            <div style={{ padding: "14px 16px", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
              ...
              <div style={{ textAlign: "right", flexShrink: 0 }}>
                ...
                <button onClick={onContact} style={{
                  ...
                  cursor: "pointer", letterSpacing: "0.1em", fontFamily: "'DM Sans', sans-serif",
                  whiteSpace: "nowrap",
                }}>RÉSERVER</button>
              </div>
            </div>
...
export default function WayzaPrestigeApp() {
  ...
  const renderMain = () => {
    ...
    if (tab === "contact") return <ContactsScreen onInscription={() => setShowInscription(true)} />;    if (tab === "urg") return <UrgencesScreen onInscription={() => setShowInscription(true)} />;
  };
    ...
    <div className="wayza-app-root" style={{
      ...
      <style>{`
        ...
        * { scrollbar-width: none; box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Playfair sur les titres éditoriaux */
        h1, h2, h3 { font-family: 'Playfair Display', Georgia, serif; }
        .wz-serif { font-family: 'Playfair Display', Georgia, serif !important; }
        .wz-sans  { font-family: 'DM Sans', sans-serif !important; }
        /* Grilles spots */
        ...
        /* Carte hover raffiné */
        .wz-card { transition: transform 0.18s ease, border-color 0.18s ease; }
        .wz-card:hover { transform: translateY(-3px); }
        /* Gold line accent comme sur le site présentation */
        .wz-gold-quote { border-left: 2px solid #C8920A; padding-left: 14px; }
      `}</style>
      ...
      {!selectedSpot && (
        <div className="wayza-top-header" style={{ padding: "16px 20px 10px", flexShrink: 0, display: (isDesktop || isMobileLandscape) ? "none" : "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
            <p style={{ fontSize: 8, letterSpacing: "0.35em", color: "rgba(244,247,247,0.35)", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, marginBottom: 2 }}>MADAGASCAR</p>
            <h1 style={{ fontSize: 30, fontWeight: 900, fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif", lineHeight: 1, color: "#F4F7F7" }}>
      ...
      <div className="wayza-main-layout" style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: isDesktop ? "row" : "column", minHeight: 0 }}>
        ...
        <div className="wayza-sidebar" style={{ display: isDesktop ? "flex" : "none", flexDirection: "column", width: 240, minWidth: 240, background: "rgba(0,0,0,0.3)", borderRight: "0.5px solid rgba(200,146,10,0.15)", padding: "24px 16px", gap: 4, overflowY: "auto" }}>
          <div style={{ marginBottom: 20 }}>
            <p style={{ fontSize: 8, letterSpacing: "0.35em", color: "rgba(244,247,247,0.35)", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, marginBottom: 4 }}>MADAGASCAR</p>
            <h1 style={{ fontSize: 20, fontWeight: 900, fontStyle: "italic", fontFamily: "'Playfair Display', Georgia, serif", color: "#F4F7F7", lineHeight: 1 }}>
              WAYZA <span style={{ color: "#C8920A" }}>2026</span>
            </h1>
          </div>
          ...
          {/* Wayz'Mag en haut */}
          {(() => {
            const MAG_GLOW = "#C8920A";
            const magActive = tab === "mag" && !selectedSpot;
            return (
              <button onClick={() => { setTab("mag"); setSelectedSpot(null); setSelectedArticle(null); }} style={{
                background: magActive ? `${MAG_GLOW}18` : "rgba(200,146,10,0.06)",
                border: `0.5px solid ${magActive ? MAG_GLOW : "rgba(200,146,10,0.3)"}`,
                borderLeft: `3px solid ${MAG_GLOW}`,
                borderRadius: 12, padding: "12px 14px", cursor: "pointer", width: "100%", textAlign: "left",
                display: "flex", alignItems: "center", gap: 10, marginBottom: 8,
                boxShadow: magActive ? `0 0 12px ${MAG_GLOW}30` : "none",
              }}>
                <span style={{ fontSize: 18, flexShrink: 0 }}>◈</span>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <span style={{ fontSize: 11, color: magActive ? MAG_GLOW : "#F4F7F7", letterSpacing: "0.1em", fontFamily: "'DM Sans', sans-serif", fontWeight: 800, display: "block" }}>
                    WAYZ'MAG
                  </span>
                  <span style={{ fontSize: 9, color: "rgba(244,247,247,0.35)", display: "block", marginTop: 1 }}>Le mag de Madagascar</span>
                </div>
                <Icon name="sparkles" size={14} color={magActive ? MAG_GLOW : "rgba(200,146,10,0.4)"} />
              </button>
            );
          })()}
          ...
          {(() => {
            ...
            return (
              <button onClick={() => { setTab("contact"); setSelectedSpot(null); setSelectedArticle(null); }} style={{
                ...
                <span style={{ fontSize: 11, color: active ? "#C8920A" : "rgba(244,247,247,0.5)", letterSpacing: "0.12em", fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}>
                  CONTACT
                </span>
              </button>
            );
          ...
          {CATEGORIES.map(cat => {
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <span style={{ fontSize: 10, color: "rgba(244,247,247,0.7)", fontFamily: "'DM Sans', sans-serif", fontWeight: 600, display: "block", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{cat.name}</span>
          ...
          <div style={{ marginTop: "auto", paddingTop: 16 }}>
            <div style={{ background: "rgba(0,0,0,0.4)", borderTop: "0.5px solid rgba(200,146,10,0.2)", overflow: "hidden", borderRadius: 8, padding: "5px 0" }}>
              <div style={{ animation: "ticker 30s linear infinite", whiteSpace: "nowrap", display: "inline-block" }}>
                <span style={{ fontSize: 8, fontWeight: 700, letterSpacing: "0.2em", color: "#C8920A", fontFamily: "'DM Sans', sans-serif" }}>
                  {tickerText}
                </span>
              </div>
            </div>
      ...
      {/* Ticker dynamique — visible sur mobile ET paysage mobile, masqué sur desktop */}
      {!isDesktop && (
        <div style={{ background: "#000", padding: "4px 0", borderTop: "0.5px solid rgba(200,146,10,0.2)", overflow: "hidden", flexShrink: 0, zIndex: 50, position: "relative" }}>
          <div style={{ animation: "ticker 45s linear infinite", whiteSpace: "nowrap", display: "inline-block" }}>
            <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: "0.25em", color: "#C8920A", fontFamily: "'DM Sans', sans-serif" }}>
              {tickerText}
            </span>
          </div>
        </div>
      ...
      {/* Bottom nav */}
      <div className="wayza-bottom-nav" style={{ position: "relative", bottom: 0, left: 0, right: 0, padding: isMobileLandscape ? "6px 20px 8px" : "10px 20px 18px", paddingTop: isMobileLandscape ? "6px" : "8px", background: "linear-gradient(to top, #0D2B30 70%, transparent)", flexShrink: 0, display: isDesktop ? "none" : "block", overflow: "visible" }}>
              ...
              <button key={item.id} onClick={() => { setTab(item.id); setSelectedSpot(null); setSelectedArticle(null); }} style={{
                ...
                {item.id === "mag" ? (
                  <div style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: 6 }}>
                    ...
                    <span style={{ fontSize: 9, color: active ? "#C8920A" : "rgba(244,247,247,0.5)", letterSpacing: "0.12em", fontFamily: "'DM Sans', sans-serif", fontWeight: 800 }}>
                      WAYZ'MAG
                    </span>
                  </div>
                ) : (
                ...
                {item.id !== "mag" && (
                  <span style={{ fontSize: 8, color: active ? "#C8920A" : "rgba(244,247,247,0.3)", letterSpacing: "0.12em", fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}>
                    {item.label}
                  </span>
                )}
              </button>
