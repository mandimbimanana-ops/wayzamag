...
export default function WayzaPrestigeApp() {
  ...
  const navItems = [
    ...
    { id: "offres",  icon: "sparkles", label: "OFFRES" },
    ...
    <div className="wayza-app-root" style={{
      ...
      <div className="wayza-main-layout" style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: isDesktop ? "row" : "column", minHeight: 0 }}>
        ...
        <div className="wayza-sidebar" style={{ display: isDesktop ? "flex" : "none", flexDirection: "column", width: 240, minWidth: 240, background: "rgba(0,0,0,0.3)", borderRight: "0.5px solid rgba(200,146,10,0.15)", padding: "24px 16px", gap: 4, overflowY: "auto" }}>
          ...
          {/* Bouton Offres */}
          {(() => {
            const active = tab === "offres" && !selectedSpot;
            return (
              <button onClick={() => { setTab("offres"); setSelectedSpot(null); setSelectedArticle(null); }} style={{
                ...
                <Icon name="sparkles" size={16} color={active ? "#C8920A" : "rgba(244,247,247,0.4)"} />
      ...
      {/* Bottom nav */}
      <div className="wayza-bottom-nav" style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: isMobileLandscape ? "6px 20px 8px" : "12px 20px 20px", background: "linear-gradient(to top, #0D2B30 60%, transparent)", flexShrink: 0, display: isDesktop ? "none" : "block", overflow: "visible" }}>
