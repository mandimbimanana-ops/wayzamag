...
export default function WayzaPrestigeApp() {
  ...
  return (
    <div className="wayza-app-root" style={{
      ...
      {/* Header */}
      {!selectedSpot && (
        <div className="wayza-top-header" style={{ padding: "16px 20px 10px", flexShrink: 0, display: isDesktop ? "none" : "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
      ...
      {/* Bottom nav */}
      <div className="wayza-bottom-nav" style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "12px 20px 20px", background: "linear-gradient(to top, #0D2B30 60%, transparent)", flexShrink: 0, display: isDesktop ? "none" : "block" }}>
