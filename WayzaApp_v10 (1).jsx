...
const InscriptionBanner = () => (
  <div style={{
    ...
    <a href="https://wa.me/261320000000" target="_blank" rel="noreferrer" style={{
      background: "#C8920A", color: "#0D2B30", borderRadius: 24, padding: "10px 24px",
      fontWeight: 800, fontSize: 11, letterSpacing: "0.12em", textDecoration: "none",
